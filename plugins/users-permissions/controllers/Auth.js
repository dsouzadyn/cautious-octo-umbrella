...
module.exports = {
  ...
  register: async (ctx) => {
    ...
    try {
      ...
      const v = await strapi.api.checker.services.checker.add({'is_valid': false, 'user': user});
      const mailOptions = {
        from: 'dsouzadyn@outlook.com',
        to: user.email,
        subject: 'Email verification!',
        html: 'Click <a href="http://etamax.fcrit.ac.in:1337/checker/' + v.id + '/validate">here</a> to verify your email address.'
      }
